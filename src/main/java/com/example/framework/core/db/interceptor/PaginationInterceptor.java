...
import com.example.framework.core.db.dialect.Dialect;
...
public class PaginationInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        try {
            ...
            if (originalSql != null && invocationObj != null && invocationObj instanceof Page) {
                ...
                // 2016-11-11 zhengkw 解决foreach问题 start
                ...
                if (metaParamsField != null) {
                    ...
                    ReflectHelper.setValueByFieldName(newBoundSql, "metaParameters", mo);
                }
                // 2016-11-11 zhengkw 解决foreach问题 end
	...
	private String generatePageSql(String originalSql, Page page) throws PropertyException {
			String pageSql = dialect.getLimitString(originalSql, (page.getPageNo() - 1)* page.getPageSize(), page.getPageSize());
			log.debug((page.getPageNo() - 1) * page.getPageSize());
			log.debug(page.getPageNo() * page.getPageSize());
			log.debug(pageSql);
	...
	public void setProperties(Properties p) {   
		...
		if(StringUtils.isBlank(dialectClass)) {
			throw new IllegalStateException("required property is blank by key = dialectClass");
		}   
        try {   
